            ...
            `(,(make-mu4e-context
                ...
                :vars '((user-mail-address . "eqyiel@internode.on.net")
                        ...
                        (mu4e-maildir-shortcuts
                         . (("/eqyiel@internode.on.net/Inbox"   . ?i)
                            ...
                            ("/eqyiel@internode.on.net/Trash"   . ?t)
              ...
              ,(make-mu4e-context
                ...
                :vars '((user-mail-address . "mahe0054@flinders.edu.au")
                        (mu4e-sent-folder . "/mahe0054@flinders.edu.au/Sent Items")
                        (mu4e-refile-folder . "/mahe0054@flinders.edu.au/Archive")
                        (mu4e-drafts-folder . "/mahe0054@flinders.edu.au/Drafts")
                        (mu4e-trash-folder . "/mahe0054@flinders.edu.au/Trash")
                        (mu4e-sent-messages-behavior . sent)
                        (mu4e-compose-crypto-reply-policy . sign-and-encrypt)
                        (mu4e-maildir-shortcuts
...
#+BEGIN_SRC emacs-lisp
  ...
  (defun eqyiel/should-format-with-prettier-p ()
    (let ((package-file (concat (eqyiel/locate-js-project-root default-directory) "/package.json")))
      (if (and (file-readable-p package-file) (file-exists-p package-file))
          (let ((package-file-as-string (json-read-file package-file)))
            (caar
             (delq
              nil
              (mapcar
