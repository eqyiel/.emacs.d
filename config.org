...
#+BEGIN_SRC emacs-lisp
  ...
  ;; TODO: make this more generic so that it can be used for other project-local
  ;; js things
  (defun eqyiel/prettier-make-project-local-prettier-cmd-path (local-prettier-cmd)
  ...
  found."
    (let* ((local-prettier-cmd-path
            (eqyiel/prettier-make-project-local-prettier-cmd-path "prettier")))
