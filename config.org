    ...
    (progn
      ...
      (setq
       ...
       '(("rkm.id.au.*"
          ...
          (expiry-target . "rkm.id.au/Archive"))
         ("rkm.id.au/github/*"
          (auto-expire . t)
          (expiry-wait . 28) ;; days
          (expiry-target . "rkm.id.au/Trash"))
         ("rkm.id.au/lists/*"
          (auto-expire . t)
          (expiry-wait . 28) ;; days
          (expiry-target . "rkm.id.au/Trash"))
         ("rkm.id.au/Marketing Spam"
          (expiry-wait . immediate)
          (expiry-target . "rkm.id.au/Trash"))
         ("gmail.com.*"
          (display . default)
         ...
         ("mangochutney.com.au.*"
          ...
          (expiry-target . "mangochutney.com.au/Bin"))
         ("internode.on.net.*"
          (display . default)
          (auto-expire . nil)
          (expiry-wait . immediate)
          ...
          (expiry-target . "internode.on.net/Bin"))
         ("flinders.edu.au.*"
          (display . default)
          (auto-expire . nil)
          (expiry-wait . immediate)
          ...
          (expiry-target . "flinders.edu.au/Trash"))
         ("huttriverprovince.com.au.*"
          ...
          (expiry-target . "huttriverprovince.com.au/Trash"))))
      ...
      (if (eq system-type 'darwin)
          (progn
            (setq
             gnus-select-method
             `(nnmaildir ""
                         (directory eqyiel/mail-directory)
                         (get-new-mail nil)
                         (nnir-search-engine notmuch))
             nnir-notmuch-remove-prefix (expand-file-name eqyiel/mail-directory))
            (add-hook
        ...
        (setq
         ...
         '(nnimap
           ...
           (nnimap-inbox "rkm.id.au/Inbox")
           (nnir-search-engine imap)
           (nnimap-split-methods 'nnmail-split-fancy)
           (nnimap-split-fancy
            (|
             ;; Mailing lists
             ("List-Id" ".*nix-dev.lists.science.uu.nl.*" "rkm.id.au/lists/nix-dev")
             (any ".*@github.com.*" "rkm.id.au/github")

             ;; IDK
             (to ".*adele@rkm.id.au.*" "rkm.id.au/Spam")
             (to ".*crazydaiz@rkm.id.au.*" "rkm.id.au/Spam")
             (to ".*rolf@rkm.id.au.*" "rkm.id.au/Spam")
             (to ".*tarot@rkm.id.au.*" "rkm.id.au/Spam")
             "rkm.id.au/Inbox")))))

      (setq nnir-notmuch-remove-prefix eqyiel/mail-directory)

      (setq gnus-topic-topology
            '(("Gnus" visible nil nil)
              (("rkm.id.au" visible nil nil))
              (("internode.on.net" visible nil nil))
              (("flinders.edu.au" visible nil nil))
              (("gmail.com" visible nil nil))
              (("huttriverprovince.com.au" visible nil nil))
              (("mangochutney.com.au" visible nil nil))))

      (setq gnus-topic-alist
            '(("Gnus" "archive" "nndraft:drafts")
              (
               "flinders.edu.au"
               "flinders.edu.au/Archive"
               "flinders.edu.au/Calendar"
               "flinders.edu.au/Clutter"
               "flinders.edu.au/Contacts"
               "flinders.edu.au/Conversation History"
               "flinders.edu.au/Deleted Items"
               "flinders.edu.au/Drafts"
               "flinders.edu.au/Inbox"
               "flinders.edu.au/Journal"
               "flinders.edu.au/Junk E-Mail"
               "flinders.edu.au/Keep"
               "flinders.edu.au/Notes"
               "flinders.edu.au/Outbox"
               "flinders.edu.au/Sent Items"
               "flinders.edu.au/Tasks"
               "flinders.edu.au/Trash"
               )
              (
               "gmail.com"
               "gmail.com/Bin"
              ...
              (
               "huttriverprovince.com.au"
               "huttriverprovince.com.au/Archive"
               "huttriverprovince.com.au/Drafts"
               "huttriverprovince.com.au/Inbox"
               "huttriverprovince.com.au/Marketing Spam"
              ...
              (
               ...
               "internode.on.net/Trash"
               "internode.on.net/Drafts"
               "internode.on.net/Inbox"
              ...
              (
               "mangochutney.com.au"
               "mangochutney.com.au/Bin"
               "mangochutney.com.au/Inbox"
               "mangochutney.com.au/Sent"
               "mangochutney.com.au/Spam"
               ))))
    :init
    (progn
...
#+begin_src emacs-lisp
  ...
  (use-package org
    ...
    (setq
     ...
     '(("t" "Todo" entry (file (concat "~/org/todo-" (system-name) ".org"))
        "* TODO %?\nSCHEDULED: %(org-insert-time-stamp (org-read-date nil t \"+0d\"))"
        '(:empty-lines 1
          :kill-buffer t))
       ("s" "Shopping" entry (file (concat "~/org/shopping-" (system-name) ".org"))
        "* TODO %?\nSCHEDULED: %(org-insert-time-stamp (org-read-date nil t \"+0d\"))"
        '(:empty-lines 1
          :kill-buffer t))))
    :init
