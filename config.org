...
#+begin_src emacs-lisp
  ...
  (global-set-key (kbd "C-x 9") 'eqyiel/sort-lines-or-words)
            ...
            `(,(make-mu4e-context
              ...
              ,(make-mu4e-context
                ...
                :vars `((user-mail-address . "r-maher@mercari.com")
                        ...
                        (mu4e-trash-folder . "/r-maher@mercari.com/Bin")
                        ;; GMail already takes care of keeping copies in the sent
                        ;; folder
                        (mu4e-sent-messages-behavior . delete)
                        (mu4e-maildir-shortcuts
                         . (("/r-maher@mercari.com/All Mail"  . ?i)
                            ("/r-maher@mercari.com/Drafts"    . ?d)
                            ("/r-maher@mercari.com/Bin"       . ?t)
...
#+BEGIN_SRC emacs-lisp
  ...
  (defun eqyiel/ts-should-enable ()
    ...
    (let ((tsserver-executable (eqyiel/ts-tsserver-find-executable)))
      (and (or (string-equal "ts" (file-name-extension (buffer-file-name)))
