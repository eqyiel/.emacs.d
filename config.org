...
** ~markdown-mode~                                                   :melpa:
#+BEGIN_SRC emacs-lisp
  (defun eqyiel/markdown-lint-error-parser (output checker buffer)
  ...
  (use-package markdown-mode
    ...
    (progn
      ...
      (use-package flycheck
        ...
        (progn
          (require 'warnings)
          (flycheck-define-checker markdown-lint
            "Flycheck plugin for markdown-mode"
            :command ("markdown-lint" "--report" "json" source-inplace)
            :error-parser eqyiel/markdown-lint-error-parser
            :modes markdown-mode))))
    :init (add-to-list 'flycheck-checkers 'markdown-lint)
