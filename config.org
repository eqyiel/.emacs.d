...
#+begin_src emacs-lisp
  ...
  (defun eqyiel/psql ()
    ...
    (if (member
        ...
        (sql-postgres)
      (progn
        (setq sql-buffer (sql-comint-postgres 'postgres sql-postgres-options))
      ...
      (setq mu4e-contexts
            `(,(make-mu4e-context
                ...
                :vars '((user-mail-address . "ruben@maher.fyi")
                        ...
                        (mu4e-refile-folder . "/ruben@maher.fyi/Archive")
...
#+BEGIN_SRC emacs-lisp
  ...
  Returns current working directory if no package.json was found found."
    (directory-file-name
     (expand-file-name
      (or (locate-dominating-file path "package.json")
          default-directory))))
...
This is [[https://github.com/Fuco1/rjsx-mode][Fuco1's]] fork of
[[https://github.com/antifuchs/rjsx-mode][antifuch's]] fork of
[[https://github.com/felipeochoa/rjsx-mode][~rjsx-mode~]] with improved flow
editing support.

Sample usage:
https://github.com/Fuco1/.emacs.d/blob/3deefbabb0c1765abd88743e61ee42846353525f/files/vendor.el#L1078-L1123
...
#+BEGIN_SRC emacs-lisp
  (use-package rjsx-mode
    ...
    (progn
        ...
        (condition-case nil
            (use-package flow-js2-minor-mode
              :load-path "site-lisp/rjsx-mode/flow-js2-minor-mode.el"
              :demand t
              :ensure nil)
          (error nil))
        ...
        (add-hook 'rjsx-mode-hook 'eqyiel/rjsx-mode-hook)
