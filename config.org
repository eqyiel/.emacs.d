...
#+BEGIN_SRC emacs-lisp
  (use-package rjsx-mode
    ...
    (progn
        ...
        (defun eqyiel/company-rjsx-mode ()
          (set (make-local-variable 'company-backends)
               '((company-files
                  company-flow
                  company-yasnippet))))

        (add-hook 'rjsx-mode-hook 'eqyiel/company-rjsx-mode)

        ;; This should be smarter, like the prettier thing
        (defun eqyiel/rjsx-flycheck-setup ()
          (require 'flycheck)
        ...
        (add-hook 'rjsx-mode-hook 'eqyiel/rjsx-flycheck-setup)
