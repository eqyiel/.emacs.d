...
#+BEGIN_SRC emacs-lisp
  ...
  (use-package use-package-chords :config (key-chord-mode t) :demand)
#+END_SRC
...
#+BEGIN_SRC emacs-lisp
  (use-package company
    ...
    :init
    (progn
      (use-package company-emoji :demand)
...
#+BEGIN_SRC emacs-lisp
  (use-package nix-mode
    ...
    :init (progn
            (defalias 'nix-format-buffer 'nixpkgs-fmt-buffer)
